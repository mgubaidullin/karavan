...
export class CamelUi {
    ...
    static getTitle = (element: CamelElement): string => {
        ...
        if (k) {
            ...
            return uri ? CamelUi.capitalizeName(element.dslName) + ":" + uri : CamelUi.capitalizeName(element.dslName);
        }
    }
    ...
    static camelizeName = (name: string, separator: string, firstSmall: boolean) => {
        const res = name.split(separator).map(value => CamelUi.capitalizeName(value)).join("");
